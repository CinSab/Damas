...
public class Damas extends JPanel implements ActionListener, MouseListener {
    ...
    public static int[][] availablePlays = new int[numTilesPerRow][numTilesPerRow]; //almacena juegos disponibles en un 8x8
    public int storedRow, storedCol; //fila y columna almacenada
    public boolean isJump = false;
    static BufferedImage crownImage = null;


    public Damas(){
        VentanaDamas ventana = new VentanaDamas(this);
        initializeBoard();
